<?php
#ä
require_once 'class.DBTypes.php';


// diese typen sind für die abstraction on oracle u benutzen
 ...
 */
class DBCreoleTypes extends DBTypes {
    ...
    public static function getCreoleFunctionNames($phptype){
