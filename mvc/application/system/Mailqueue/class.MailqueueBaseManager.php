...
abstract class MailqueueBaseManager extends MailqueueAbstractionLayer { 
	 ...
	 * @return MailqueueList
	 */
	public static final function getMailqueueListByManagerid($managerid, SQLLimit &$myLimit = null){
		return parent::getMailqueueListBySql(self::MANAGERID.' = ?', array($managerid), $myLimit);
	}
	...
	public static final function getMailqueueByMailqueueRecipient(MailqueueRecipient &$myObject){
		return self::getMailqueueByMailqueueid($myObject->getMailqueueid());
	}
