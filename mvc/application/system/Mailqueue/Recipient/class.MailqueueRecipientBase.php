...
abstract class MailqueueRecipientBase extends BaseObject { 
	...
	public function getMailqueue(){
		if(empty($this->ref_mailqueue))
			$this->ref_mailqueue = MailqueueRecipientManager::getMailqueueByMailqueueRecipient($this);
	...
	public function getRecipienttype(){
		if(empty($this->ref_mailqueue_recipienttype))
			$this->ref_mailqueue_recipienttype = MailqueueRecipientManager::getMailqueueRecipienttypeByMailqueueRecipient($this);
